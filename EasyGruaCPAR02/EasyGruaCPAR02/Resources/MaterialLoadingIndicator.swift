...
class MaterialLoadingIndicator: UIView {
    ...
    private func startColorAnimation() {
        ...
        color.duration = 10.0
        color.values = [UIColor(red:0.10, green:0.41, blue:0.65, alpha:1.0).cgColor, UIColor(red:0.92, green:0.08, blue:0.55, alpha:1.0).cgColor, UIColor(red:0.60, green:0.21, blue:0.60, alpha:1.0).cgColor, UIColor(red:0.14, green:0.64, blue:0.65, alpha:1.0).cgColor]
        /*
